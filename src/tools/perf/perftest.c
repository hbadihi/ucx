...
test_type_t tests[] = {
    ...
    {"ucp_put_with_imm_latency", UCX_PERF_API_UCP, UCX_PERF_CMD_PUT_WITH_IMM, UCX_PERF_TEST_TYPE_PINGPONG,
    ...
    {"ucp_signal_with_imm_lat", UCX_PERF_API_UCP, UCX_PERF_CMD_SIGNAL_WITH_IMM, UCX_PERF_TEST_TYPE_PINGPONG,
     "signal with immediate latency", "latency", 1},
